...
func (Generate) code() error {
	...
	findArgs := []string{
		".", "-name", "zz_generated.deepcopy.go", "-exec",
...
func patchAddonOperatorCSV(ctx context.Context,
	cluster *dev.Cluster,
	operatorCSV *operatorsv1alpha1.ClusterServiceVersion,
) error {
...
func (d Dependency) Opm() error {
	...
	if err := os.Chmod(tempOPMBin, 0o755); err != nil {
...
func (d Dependency) PkoCli() error {
	...
	if err := os.Chmod(tempPkoCliBin, 0o755); err != nil {
